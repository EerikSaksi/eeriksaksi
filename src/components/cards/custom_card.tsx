...
const CustomCard = forwardRef<unknown, { children: React.ReactNode; style?: React.CSSProperties, containerStyle?: React.CSSProperties }>(({ children, style, containerStyle  }, ref) => {
  ...
  return (
    <Grid alignItems='center' container style={{  height: `calc(100vh - ${theme.spacing(6) + 64}px)`, marginBottom: theme.spacing(6) + 64,  minWidth: '100%',  scrollSnapAlign: 'center',  scrollSnapStop: 'always', overflow:'visible', ...containerStyle }}>
      <Grid item xs={12}>
