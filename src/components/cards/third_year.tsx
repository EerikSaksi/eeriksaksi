...
const questionAnswers = [
  {
    ...
    answer: (
      <CourseTable headers = {['First Semester','Second Semester']} rowCols={rows}>
        <Typography variant='h5'>Through both semesters, I also had a team project where we worked with a customer that was worth 33% of our grade.</Typography>
      </CourseTable>
    ),
  },
  { question: 'What were my favourite courses?', answer: <Typography variant='h4'>I found Database Systems to be helpful to me for creating better and more extensible database schemas. Cyber Security Fundamentals has made me more vary of my security choices in applications</Typography> },
